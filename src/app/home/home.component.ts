...
export class HomeComponent implements OnInit {
  ...
  talks = [
    ...
    { "event": "KUBERNETES COMMUNITY DAYS SPAIN", "title": "K8s Happiness: From Kustomize to Helm", "date": "Nov, 2022", "href": "https://community.cncf.io/events/details/cncf-kcd-spain-presents-kcd-spain-2022/#agenda" },
  ]
  projects = [
